...
#
# Usage:
#   sbatch run_normal_job.sh --model <olmo|qwen|qwen3|gemma|gemma4|llama> --dataset <harmful|sycophancy|verse|...> [--type "last mean positional"] [--nocache] [--unnormalized] [--attention] [--patch] [--global] [--split val|test] [--judging]
