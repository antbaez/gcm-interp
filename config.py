...
class Config:
    ...
    def parse_arguments(self):
        ...
        parser.add_argument('-layers', '--layers', type=int, nargs='+', default=None, help='Explicit layers to steer, overriding the default middle-third sweep (used to pin a validation-selected layer)')
        ...
        parser.add_argument('--global', dest='global_steer', action='store_true', help='Steer all layers simultaneously (default is a single-layer sweep over the middle third of layers)')
